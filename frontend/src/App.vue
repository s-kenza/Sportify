...
<template>
    ...
    <div class="navbar-end">
      ...
      >
        ...
        >
          ...
          <li>
            <a @click="this.logOut()">Se déconnecter</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  >
    <div class="grid grid-flow-col gap-4">
      ...
      <a class="link link-hover">Termes</a>
      <a class="link link-hover">Gérer les cookies</a>
    </div>
    <div>
      <div class="grid grid-flow-col gap-4">
        <a
    ...
    <div>
      <p>Copyright © 2024 - Tous droits réservés par Kenza SCHULER</p>
    </div>
  </footer>
</template>
