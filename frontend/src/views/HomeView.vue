  ...
  <main class="flex flex-col space-y-4 p-2 md:p-0">
    <div class="hero bg-neutral py-20 rounded-md shadow-md">
      <div class="hero-content text-center">
        <div class="max-w-md">
          <h1 class="text-5xl font-bold text-white">Bienvenue</h1>
          <p class="py-6 text-white">
            Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda
            excepturi exercitationem quasi. In deleniti eaque aut repudiandae et
            a id nisi.
          </p>
          <button class="btn btn-primary">Voir les articles</button>
        </div>
      </div>
    </div>
    <!-- Produits récents -->
    <h2 class="font-bold text-2xl">Produits récents</h2>
    <ProductGrid :products="this.products"></ProductGrid>
    <!-- Boutiques -->
    <h2 class="font-bold text-2xl">Boutiques</h2>
    ...
    <!-- Catégories -->
    <h2 class="font-bold text-2xl">Catégories</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <div
