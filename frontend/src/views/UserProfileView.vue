  ...
  <main>
    <div class="flex flex-col space-y-4 mx-2 md:mx-0 items-center">
      ...
      <div class="rounded-md shadow-md w-full p-8">
        ...
        >
          <h2 class="font-bold text-2xl">Mes informations</h2>
          <label for="updateUserInfo" class="btn btn-primary modal-button"
            >Mettre à jour les informations</label
          >
        </div>
      ...
      <div class="rounded-md shadow-md w-full p-8">
        <h2 class="font-bold text-2xl">Mes commandes</h2>
        <div class="divider"></div>
    ...
    <div class="modal">
      <div class="modal-box w-11/12 max-w-5xl">
        <label
          ...
          >✕</label
        >
        <h3 class="font-bold text-lg">Mettre à jour vos informations</h3>
        <div class="divider"></div>
        <form
          action="POST"
        ...
        >
          <div>
            <h4 class="font-bold text-base">À propos de vous</h4>
